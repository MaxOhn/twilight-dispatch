...
lazy_static! {
    pub static ref CONFIG: Config = {
        Config {
            ...
            member_request_delay_ms: get_env_as("MEMBER_REQUEST_DELAY_MS"),
            cache_update_deadline_ms: get_env_as("CACHE_UPDATE_DEADLINE_MS"),
            cache_user_expire: get_env_as("CACHE_USER_EXPIRE"),
...
pub struct Config {
    ...
    pub resume: bool,
    pub member_request_delay_ms: u64,
    pub cache_update_deadline_ms: u64,
    pub cache_user_expire: usize,
    pub intents: u64,
